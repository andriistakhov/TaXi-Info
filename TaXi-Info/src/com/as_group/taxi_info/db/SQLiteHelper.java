...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_CITY = "CREATE TABLE if not exists " + TB_CITY + " (" + COLUMN_ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, " + COLUMN_CITY_ID + " INTEGER DEFAULT 0," + COLUMN_CITY_NAME + " TEXT NOT NULL)";
    private static final String CREATE_TABLE_TAXI_SERVICE = "CREATE TABLE if not exists " + TB_TAXI_SERVICE + " (" + COLUMN_ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, " + COLUMN_TAXI_SERVICE_ID + " INTEGER DEFAULT 0, " + COLUMN_TAXI_SERVICE_NAME + " TEXT NOT NULL, " + COLUMN_CITY_ID + " INTEGER DEFAULT 0, " + COLUMN_TAXI_SERVICE_RATE + " DOUBLE DEFAULT 0.0)";
